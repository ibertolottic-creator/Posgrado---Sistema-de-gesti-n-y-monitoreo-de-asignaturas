...
- **Separación Estricta de Tiempos y Ráfagas (LMS vs Acomp):** Tiempos y alertas diferenciados por origen (`audit_time_s*` vs `a_audit_time_*`, `audit_burst` vs `a_audit_burst`).
